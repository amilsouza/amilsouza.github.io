...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let play1 = window.prompt('Qual o nome do jogador 1:')
  let play2 = window.prompt('Qual o nome do jogador 2:')
  ...
  for (var i = 0, len = squares.length; i < len; i++)
    (function (index) {
      ...
      squares[i].onclick = function () {
        ...
        } else alert("começe pela parte de baixo do quadrado");
      }
    })(i)
  ...
  function checkBoard() {
    ...
    //now take the 4 values in each winningArray and plug then into the square
    for (let y = 0; y < winningArrays.length; y++) {
      ...
      if (
        ...
        result.innerHTML = "Jogador "+play1+" ganhou !";
        goAgain()
      }
      //
      else if (
        ...
        result.innerHTML = "Jogador "+play2+" ganhou !";
        goAgain()
      }
    }
  }
